__all__ = ['DeExtremeMethod', 'StandardizeMethod', 'GroupingMethod', 'WeightMethod', 'NeutralizeMethod']
import pandas as pd
import numpy as np
import statsmodels.api as sm


class DeExtremeMethod(object):
    """去极值方法"""
    ...
    def Method_Median(cls, factor_series, multiple=5.2):
        ...
        upper_limit = distance_to_median + multiple * median_of_distance  # 上轨
        lower_limit = distance_to_median - multiple * median_of_distance  # 下轨
        # 替换数据
...
class StandardizeMethod(object):
    def __init__(self):
        pass
